...
public class WordDataTypeImpl implements edu.uconn.psy.jtrace.parser.WordDataType, com.sun.xml.bind.JAXBObject, edu.uconn.psy.jtrace.parser.impl.runtime.UnmarshallableObject, edu.uconn.psy.jtrace.parser.impl.runtime.XMLSerializable, edu.uconn.psy.jtrace.parser.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.uconn.psy.jtrace.parser.WordDataType.class);
    }
    ...
    public edu.uconn.psy.jtrace.parser.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.uconn.psy.jtrace.parser.impl.runtime.UnmarshallingContext context) {
        return new edu.uconn.psy.jtrace.parser.impl.WordDataTypeImpl.Unmarshaller(context);
    }
...
+"\u0000\u0012Ljava/lang/String;L\u0000\fnamespaceURIq\u0000~\u0000\u001exq\u0000~\u0000\u0019t\u00000edu.uconn.p"
+"sy.jtrace.parser.WordDataType.RowTypet\u0000+http://java.sun.com/"
...
+"\u0000\u0003rowt\u0000)http://xml.netbeans.org/examples/targetNSsr\u0000\"com.sun"
...
+"pq\u0000~\u0000\u0010q\u0000~\u0000\fq\u0000~\u0000\u0005q\u0000~\u0000\"q\u0000~\u0000\u000fx"));
    ...
    public static class RowTypeImpl implements edu.uconn.psy.jtrace.parser.WordDataType.RowType, com.sun.xml.bind.JAXBObject, edu.uconn.psy.jtrace.parser.impl.runtime.UnmarshallableObject, edu.uconn.psy.jtrace.parser.impl.runtime.XMLSerializable, edu.uconn.psy.jtrace.parser.impl.runtime.ValidatableObject
    {
        ...
        private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
            return (edu.uconn.psy.jtrace.parser.WordDataType.RowType.class);
        }
        ...
        public edu.uconn.psy.jtrace.parser.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.uconn.psy.jtrace.parser.impl.runtime.UnmarshallingContext context) {
            return new edu.uconn.psy.jtrace.parser.impl.WordDataTypeImpl.RowTypeImpl.Unmarshaller(context);
        }
...
+"$EpsilonExpression\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0000xq\u0000~\u0000\u0003sq\u0000~\u0000#\u0001psq\u0000~\u0000,t\u0000\u0004wordt\u0000)h"
...
+"\u0000 q\u0000~\u0000Ax"));
            ...
            extends edu.uconn.psy.jtrace.parser.impl.runtime.AbstractUnmarshallingEventHandlerImpl
        {
            ...
            public java.lang.Object owner() {
                return edu.uconn.psy.jtrace.parser.impl.WordDataTypeImpl.RowTypeImpl.this;
            }
        ...
        extends edu.uconn.psy.jtrace.parser.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.uconn.psy.jtrace.parser.impl.WordDataTypeImpl.this;
        }
            ...
            throws org.xml.sax.SAXException
        {
            ...
            while (true) {
                switch (state) {
                    ...
                    case  1 :
                        if (("word" == ___local)&&("http://xml.netbeans.org/examples/targetNS" == ___uri)) {
                            _getRow().add(((edu.uconn.psy.jtrace.parser.impl.WordDataTypeImpl.RowTypeImpl) spawnChildFromEnterElement((edu.uconn.psy.jtrace.parser.impl.WordDataTypeImpl.RowTypeImpl.class), 2, ___uri, ___local, ___qname, __atts)));
                            return ;
                        }
                        break;
                }
