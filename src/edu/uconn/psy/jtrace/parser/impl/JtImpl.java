...
public class JtImpl
    extends edu.uconn.psy.jtrace.parser.impl.JtTypeImpl
    implements edu.uconn.psy.jtrace.parser.Jt, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, edu.uconn.psy.jtrace.parser.impl.runtime.UnmarshallableObject, edu.uconn.psy.jtrace.parser.impl.runtime.XMLSerializable, edu.uconn.psy.jtrace.parser.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.uconn.psy.jtrace.parser.Jt.class);
    }
    ...
    public edu.uconn.psy.jtrace.parser.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.uconn.psy.jtrace.parser.impl.runtime.UnmarshallingContext context) {
        return new edu.uconn.psy.jtrace.parser.impl.JtImpl.Unmarshaller(context);
    }

    public void serializeBody(edu.uconn.psy.jtrace.parser.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://xml.netbeans.org/examples/targetNS", "jt");
...
+"\u0000~\u0000\u0004sq\u0000~\u0000\u000e\u0001psq\u0000~\u0000/t\u0000\u000bdescriptiont\u0000)http://xml.netbeans.org/e"
+"xamples/targetNSq\u0000~\u00005sq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u0007ppsq\u0000~\u0000\u0000pp\u0000sq\u0000~\u0000\u000bppsr\u0000 c"
...
+"\u0001\u0002\u0000\u0000xq\u0000~\u00000q\u0000~\u00005sq\u0000~\u0000/t\u0000-edu.uconn.psy.jtrace.parser.JtType.S"
+"criptTypet\u0000+http://java.sun.com/jaxb/xjc/dummy-elementssq\u0000~\u0000"
+"\u000bppsq\u0000~\u0000&q\u0000~\u0000\u000fpq\u0000~\u0000(q\u0000~\u00001q\u0000~\u00005sq\u0000~\u0000/t\u0000\u0006scriptq\u0000~\u00009sq\u0000~\u0000\u000bppsq"
+"\u0000~\u0000&q\u0000~\u0000\u000fpq\u0000~\u0000(q\u0000~\u00001q\u0000~\u00005sq\u0000~\u0000/t\u0000\u0002jtq\u0000~\u00009sr\u0000\"com.sun.msv.gra"
...
+"~\u0000@q\u0000~\u0000\fq\u0000~\u0000;q\u0000~\u0000\tq\u0000~\u0000\nq\u0000~\u0000%q\u0000~\u0000Iq\u0000~\u0000Mq\u0000~\u0000=x"));
        ...
        extends edu.uconn.psy.jtrace.parser.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.uconn.psy.jtrace.parser.impl.JtImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  0 :
                        if (("jt" == ___local)&&("http://xml.netbeans.org/examples/targetNS" == ___uri)) {
                    ...
                    case  1 :
                        if (("description" == ___local)&&("http://xml.netbeans.org/examples/targetNS" == ___uri)) {
                            spawnHandlerFromEnterElement((((edu.uconn.psy.jtrace.parser.impl.JtTypeImpl)edu.uconn.psy.jtrace.parser.impl.JtImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
