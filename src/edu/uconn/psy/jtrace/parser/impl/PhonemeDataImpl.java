...
public class PhonemeDataImpl
    extends edu.uconn.psy.jtrace.parser.impl.PhonemeDataTypeImpl
    implements edu.uconn.psy.jtrace.parser.PhonemeData, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, edu.uconn.psy.jtrace.parser.impl.runtime.UnmarshallableObject, edu.uconn.psy.jtrace.parser.impl.runtime.XMLSerializable, edu.uconn.psy.jtrace.parser.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.uconn.psy.jtrace.parser.PhonemeData.class);
    }
    ...
    public edu.uconn.psy.jtrace.parser.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.uconn.psy.jtrace.parser.impl.runtime.UnmarshallingContext context) {
        return new edu.uconn.psy.jtrace.parser.impl.PhonemeDataImpl.Unmarshaller(context);
    }

    public void serializeBody(edu.uconn.psy.jtrace.parser.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://xml.netbeans.org/examples/targetNS", "phonemeData");
...
+"~\u0000\u001bt\u00003edu.uconn.psy.jtrace.parser.PhonemeDataType.RowTypet\u0000+"
...
+"instanceq\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\u0003rowt\u0000)http://xml.netbeans.org/examples"
+"/targetNSsq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0015q\u0000~\u0000\u0014pq\u0000~\u0000)q\u0000~\u00009q\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\u000bphoneme"
+"Dataq\u0000~\u0000>sr\u0000\"com.sun.msv.grammar.ExpressionPool\u0000\u0000\u0000\u0000\u0000\u0000\u0000\u0001\u0002\u0000\u0001L\u0000"
...
+"pressionPool;xp\u0000\u0000\u0000\u0007\u0001pq\u0000~\u0000\u0012q\u0000~\u0000\u000eq\u0000~\u0000\tq\u0000~\u0000\fq\u0000~\u0000$q\u0000~\u0000?q\u0000~\u0000\u0011x"));
        }
        ...
        extends edu.uconn.psy.jtrace.parser.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.uconn.psy.jtrace.parser.impl.PhonemeDataImpl.this;
        }
            ...
            while (true) {
                switch (state) {
                    case  3 :
                        ...
                        return ;
                    case  0 :
                        if (("phonemeData" == ___local)&&("http://xml.netbeans.org/examples/targetNS" == ___uri)) {
                    ...
                    case  1 :
                        if (("row" == ___local)&&("http://xml.netbeans.org/examples/targetNS" == ___uri)) {
                            spawnHandlerFromEnterElement((((edu.uconn.psy.jtrace.parser.impl.PhonemeDataTypeImpl)edu.uconn.psy.jtrace.parser.impl.PhonemeDataImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        break;
                }
