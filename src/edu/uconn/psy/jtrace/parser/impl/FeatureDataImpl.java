...
public class FeatureDataImpl
    extends edu.uconn.psy.jtrace.parser.impl.FeatureDataTypeImpl
    implements edu.uconn.psy.jtrace.parser.FeatureData, com.sun.xml.bind.RIElement, com.sun.xml.bind.JAXBObject, edu.uconn.psy.jtrace.parser.impl.runtime.UnmarshallableObject, edu.uconn.psy.jtrace.parser.impl.runtime.XMLSerializable, edu.uconn.psy.jtrace.parser.impl.runtime.ValidatableObject
{
    ...
    private final static java.lang.Class PRIMARY_INTERFACE_CLASS() {
        return (edu.uconn.psy.jtrace.parser.FeatureData.class);
    }
    ...
    public edu.uconn.psy.jtrace.parser.impl.runtime.UnmarshallingEventHandler createUnmarshaller(edu.uconn.psy.jtrace.parser.impl.runtime.UnmarshallingContext context) {
        return new edu.uconn.psy.jtrace.parser.impl.FeatureDataImpl.Unmarshaller(context);
    }

    public void serializeBody(edu.uconn.psy.jtrace.parser.impl.runtime.XMLSerializer context)
        throws org.xml.sax.SAXException
    {
        context.startElement("http://xml.netbeans.org/examples/targetNS", "featureData");
...
+"~\u0000\u001bt\u00003edu.uconn.psy.jtrace.parser.FeatureDataType.RowTypet\u0000+"
...
+"/targetNSsq\u0000~\u0000\u0010ppsq\u0000~\u0000\u0015q\u0000~\u0000\u0014pq\u0000~\u0000)q\u0000~\u00009q\u0000~\u0000\u001esq\u0000~\u0000\u001ft\u0000\u000bfeature"
...
+"pressionPool;xp\u0000\u0000\u0000\u0007\u0001pq\u0000~\u0000\u0012q\u0000~\u0000\u000eq\u0000~\u0000\tq\u0000~\u0000\fq\u0000~\u0000$q\u0000~\u0000?q\u0000~\u0000\u0011x"));
        ...
        extends edu.uconn.psy.jtrace.parser.impl.runtime.AbstractUnmarshallingEventHandlerImpl
    {
        ...
        public java.lang.Object owner() {
            return edu.uconn.psy.jtrace.parser.impl.FeatureDataImpl.this;
        }
                ...
                switch (state) {
                    case  1 :
                        if (("row" == ___local)&&("http://xml.netbeans.org/examples/targetNS" == ___uri)) {
                            spawnHandlerFromEnterElement((((edu.uconn.psy.jtrace.parser.impl.FeatureDataTypeImpl)edu.uconn.psy.jtrace.parser.impl.FeatureDataImpl.this).new Unmarshaller(context)), 2, ___uri, ___local, ___qname, __atts);
                            return ;
                        }
                        break;
                    case  3 :
                        ...
                        return ;
                    case  0 :
                        if (("featureData" == ___local)&&("http://xml.netbeans.org/examples/targetNS" == ___uri)) {
