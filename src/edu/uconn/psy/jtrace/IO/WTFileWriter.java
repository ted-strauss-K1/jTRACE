...
public class WTFileWriter {
    ...
    public String makeWTParameterFileBody(edu.uconn.psy.jtrace.Model.TraceParam param){
        ...
        try{
            ...
            result+="\n\t<IntParam><name>lengthNormalization</name><IntValue>"+param.getLengthNormalization()+"</IntValue></IntParam>";
            ...
            //if(param.getLexicon()!=null){
            //    for(int i=0;i<param.getLexicon().size();i++)
            //       result+="\n\t\t<StringValue>"+param.getLexicon().get(i).getPhon()+"</StringValue>";                
            //}
            //result+="\n\t</StringParamRep>";
            ...
            if(param.getLexicon()!=null){
                for(int i=0;i<param.getLexicon().size();i++)
                    result+="\n\t<lexeme><phons>"+param.getLexicon().get(i).getPhon()+"</phons><freq>"+param.getLexicon().get(i).getFrequency()+"</freq></lexeme>";                
            }
            result+="\n</lexicon>";
    ...
    public String makeWTParameterFileBodyTXT(edu.uconn.psy.jtrace.Model.TraceParam param){
        ...
        try{
            ...
            result+="\nlengthNormalization"+param.getLengthNormalization();
            ...
            if(param.getLexicon()!=null){
                for(int i=0;i<param.getLexicon().size();i++)
                    result+="\n\t"+param.getLexicon().get(i).getPhon()+"\t"+param.getLexicon().get(i).getFrequency()+"\t";                
            }            
        }
        catch( Exception e ) {e.printStackTrace(); return "Exception";}
        return result;
